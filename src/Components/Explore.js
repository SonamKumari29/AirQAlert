...
function Explore() {
  ...
  return (
    <>
      ...
      <Health />
      <Result />
      <div className='but-place'>
        <button className='but2' onClick={() => navigate("/about")}>Checkout Medicines</button>
        <button className='but2' onClick={() => navigate("/about")}>Checkout Products</button>
      </div>
      <div className='map'>
